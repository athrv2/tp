...
public class EditCommandParser implements Parser<EditCommand> {
    ...
    public EditCommand parse(String args) throws ParseException {
        ...
        boolean shouldCreateNewTags = ParserUtil.parseBooleanFlag(argMultimap, PREFIX_NEWTAG,
        ...
        return new EditCommand(index, editPersonDescriptor, shouldCreateNewTags);
    }
